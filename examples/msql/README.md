...
use the [mysql module](../../modules/data-stores/mysql) to deploy a cluster of web servers 
(using [EC2](https://aws.amazon.com/ec2/) and [RDS](https://aws.amazon.com/rds/)) in an 
